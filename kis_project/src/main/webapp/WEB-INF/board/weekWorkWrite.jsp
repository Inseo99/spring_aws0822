	...
	<div class="save"> 
        ...
        <div class="save-content">
			...
			<div class="info-form">
                <h3>주간보고</h3>
                <form>
                <input type="hidden" name="reportType" value="week">
                    <table class="combined-info-table">
                        ...
                        <tr>
                            <th>이번주 한 일</th>
                            <td colspan="3">
                                <textarea name="contents" id="tw-contents" rows="6" required></textarea>
                            </td>
                        </tr>
                        <tr>
                            <th>다음주 한 일</th>
                            <td colspan="3">
                                <textarea name="contents" id="nw-contents" rows="6" required></textarea>
                            </td>
                        </tr>
                    </table>
                    <div class="btnBox">
